...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/xception71.tf_in1k-train", "aten.div.Scalar")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 2048, 10, 10]> self = ?", "number other = 100"]])
