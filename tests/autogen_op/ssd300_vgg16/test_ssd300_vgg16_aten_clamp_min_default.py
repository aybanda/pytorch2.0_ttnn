...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/ssd300_vgg16", "aten.clamp_min.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 1, 38, 38]> self = ?", "number min = 1e-12"]])
