...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/ssd300_vgg16", "aten.linalg_vector_norm.default")


@pytest.mark.parametrize(
    "input_strings",
    [["Tensor<[1, 512, 38, 38]> self = ?", "number ord = 2.0", "Optional[List[int]] dim = [1]", "bool keepdim = True"]],
)
