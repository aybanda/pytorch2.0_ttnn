...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/hrnet_w18.ms_aug_in1k-train", "aten.addmm.default")


@pytest.mark.parametrize(
    "input_strings", [["Tensor<[1000]> self = ?", "Tensor<[1, 2048]> mat1 = ?", "Tensor<[2048, 1000]> mat2 = ?"]]
)
