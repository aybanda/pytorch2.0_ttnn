...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/hrnet_w18.ms_aug_in1k-train", "aten.div.Scalar")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 2048, 7, 7]> self = ?", "number other = 49"]])
