...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/mobilenet_v3_small", "aten.view.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 576, 1, 1]> self = ?", "List[int] size = [1, 576]"]])
