...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/mobilenet_v3_small", "aten.t.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1024, 576]> self = ?"], ["Tensor<[1000, 1024]> self = ?"]])
