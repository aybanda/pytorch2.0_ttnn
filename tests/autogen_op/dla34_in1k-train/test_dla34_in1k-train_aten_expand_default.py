...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/dla34.in1k-train", "aten.expand.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 512, 1, 1]> self = ?", "List[int] size = [1, 512, 7, 7]"]])
