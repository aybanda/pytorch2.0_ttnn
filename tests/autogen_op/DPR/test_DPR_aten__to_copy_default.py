...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/DPR", "aten._to_copy.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 1, 1, 25]> self = ?", "Optional[int] dtype = torch.bfloat16"]])
