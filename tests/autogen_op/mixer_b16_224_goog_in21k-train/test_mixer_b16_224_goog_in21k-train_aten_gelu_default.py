...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/mixer_b16_224.goog_in21k-train", "aten.gelu.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 768, 384]> self = ?"], ["Tensor<[1, 196, 3072]> self = ?"]])
