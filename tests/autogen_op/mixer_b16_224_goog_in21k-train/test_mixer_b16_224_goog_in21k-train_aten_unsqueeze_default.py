...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/mixer_b16_224.goog_in21k-train", "aten.unsqueeze.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 768]> self = ?", "int dim = 1"]])
