...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/vit_l_32", "aten.cat.default")


@pytest.mark.parametrize("input_strings", [["List[Tensor] tensors = [<[1, 1, 1024]>, <[1, 49, 1024]>]", "int dim = 1"]])
