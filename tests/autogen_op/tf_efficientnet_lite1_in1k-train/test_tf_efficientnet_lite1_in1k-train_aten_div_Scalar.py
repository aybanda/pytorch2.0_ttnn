...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/tf_efficientnet_lite1.in1k-train", "aten.div.Scalar")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 1280, 8, 8]> self = ?", "number other = 64"]])
