...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/tf_efficientnet_lite1.in1k-train", "aten.expand.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 1280, 1, 1]> self = ?", "List[int] size = [1, 1280, 8, 8]"]])
