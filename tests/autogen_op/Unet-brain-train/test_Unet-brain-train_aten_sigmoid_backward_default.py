...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/Unet-brain-train", "aten.sigmoid_backward.default")


@pytest.mark.parametrize(
    "input_strings", [["Tensor<[1, 1, 256, 256]> grad_output = ?", "Tensor<[1, 1, 256, 256]> output = ?"]]
)
