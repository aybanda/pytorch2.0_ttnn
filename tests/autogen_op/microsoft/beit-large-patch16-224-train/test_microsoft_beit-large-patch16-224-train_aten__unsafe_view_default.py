...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/microsoft/beit-large-patch16-224-train", "aten._unsafe_view.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 197, 16, 64]> self = ?", "List[int] size = [1, 197, 1024]"]])
