...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/microsoft/beit-large-patch16-224-train", "aten.index.Tensor")


@pytest.mark.parametrize(
    "input_strings", [["Tensor<[732, 16]> self = ?", "List[Optional[Tensor]] indices = [<[38809]>]"]]
)
