...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/microsoft/beit-large-patch16-224-train", "aten.gelu.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 197, 4096]> self = ?"]])
