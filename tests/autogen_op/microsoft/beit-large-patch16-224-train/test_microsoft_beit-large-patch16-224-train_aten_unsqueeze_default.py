...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/microsoft/beit-large-patch16-224-train", "aten.unsqueeze.default")


@pytest.mark.parametrize(
    "input_strings", [["Tensor<[16, 197, 197]> self = ?", "int dim = 0"], ["Tensor<[1, 1024]> self = ?", "int dim = 1"]]
)
