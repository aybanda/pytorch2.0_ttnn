...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/microsoft/beit-base-patch16-224", "aten.mul.Tensor")


@pytest.mark.parametrize("input_strings", [["Tensor<[768]> self = ?", "Tensor<[1, 197, 768]> other = ?"]])
