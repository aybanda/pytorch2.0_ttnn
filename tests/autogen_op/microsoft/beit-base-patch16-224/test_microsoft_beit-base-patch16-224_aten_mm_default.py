...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/microsoft/beit-base-patch16-224", "aten.mm.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[197, 768]> self = ?", "Tensor<[768, 768]> mat2 = ?"]])
