...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/microsoft/beit-large-patch16-224", "aten.mm.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[197, 1024]> self = ?", "Tensor<[1024, 1024]> mat2 = ?"]])
