...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/microsoft/beit-base-patch16-224-train", "aten.gelu_backward.default")


@pytest.mark.parametrize(
    "input_strings", [["Tensor<[1, 197, 3072]> grad_output = ?", "Tensor<[1, 197, 3072]> self = ?"]]
)
