...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/microsoft/beit-base-patch16-224-train", "aten.cat.default")


@pytest.mark.parametrize("input_strings", [["List[Tensor] tensors = [<[1, 1, 768]>, <[1, 196, 768]>]", "int dim = 1"]])
