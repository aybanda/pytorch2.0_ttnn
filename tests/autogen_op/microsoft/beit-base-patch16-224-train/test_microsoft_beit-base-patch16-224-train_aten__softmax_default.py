...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/microsoft/beit-base-patch16-224-train", "aten._softmax.default")


@pytest.mark.parametrize(
    "input_strings", [["Tensor<[1, 12, 197, 197]> self = ?", "int dim = -1", "bool half_to_float = False"]]
)
