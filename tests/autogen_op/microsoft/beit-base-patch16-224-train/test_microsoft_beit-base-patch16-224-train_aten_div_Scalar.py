...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/microsoft/beit-base-patch16-224-train", "aten.div.Scalar")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 196, 768]> self = ?", "number other = 196"]])
