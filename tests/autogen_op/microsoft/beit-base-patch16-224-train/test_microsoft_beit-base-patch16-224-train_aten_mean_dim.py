...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/microsoft/beit-base-patch16-224-train", "aten.mean.dim")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 196, 768]> self = ?", "Optional[List[int]] dim = [1]"]])
