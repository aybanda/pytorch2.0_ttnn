...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/microsoft/beit-base-patch16-224-train", "aten.index.Tensor")


@pytest.mark.parametrize(
    "input_strings", [["Tensor<[732, 12]> self = ?", "List[Optional[Tensor]] indices = [<[38809]>]"]]
)
