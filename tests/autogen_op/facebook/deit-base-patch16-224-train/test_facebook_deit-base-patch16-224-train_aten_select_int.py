...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/facebook/deit-base-patch16-224-train", "aten.select.int")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 197, 768]> self = ?", "int dim = 1", "int index = 0"]])
