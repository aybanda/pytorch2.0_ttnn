...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/facebook/deit-base-patch16-224-train", "aten.add.Tensor")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 197, 768]> self = ?", "Tensor<[1, 197, 768]> other = ?"]])
