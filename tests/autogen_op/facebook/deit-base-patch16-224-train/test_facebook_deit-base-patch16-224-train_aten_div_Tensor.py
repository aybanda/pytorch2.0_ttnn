...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/facebook/deit-base-patch16-224-train", "aten.div.Tensor")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 12, 197, 197]> self = ?", "Tensor other = 8.0"]])
