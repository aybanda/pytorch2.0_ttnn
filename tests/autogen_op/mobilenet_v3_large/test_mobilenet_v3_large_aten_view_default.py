...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/mobilenet_v3_large", "aten.view.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 960, 1, 1]> self = ?", "List[int] size = [1, 960]"]])
