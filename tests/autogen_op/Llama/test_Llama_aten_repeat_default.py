...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/Llama", "aten.repeat.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 1, 2048, 2048]> self = ?", "List[int] repeats = [1, 1, 1, 1]"]])
