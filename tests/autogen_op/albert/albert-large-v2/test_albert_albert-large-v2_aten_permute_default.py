...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/albert/albert-large-v2", "aten.permute.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 9, 16, 64]> self = ?", "List[int] dims = [0, 2, 1, 3]"]])
