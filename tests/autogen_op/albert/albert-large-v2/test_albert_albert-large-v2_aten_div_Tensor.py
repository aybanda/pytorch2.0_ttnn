...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/albert/albert-large-v2", "aten.div.Tensor")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 16, 9, 9]> self = ?", "Tensor other = 8.0"]])
