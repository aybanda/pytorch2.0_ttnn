...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/albert/albert-base-v2", "aten.tanh.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 9, 3072]> self = ?"], ["Tensor<[1, 9, 128]> self = ?"]])
