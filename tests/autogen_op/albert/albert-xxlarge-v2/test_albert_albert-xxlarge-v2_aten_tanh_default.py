...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/albert/albert-xxlarge-v2", "aten.tanh.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 9, 16384]> self = ?"], ["Tensor<[1, 9, 128]> self = ?"]])
