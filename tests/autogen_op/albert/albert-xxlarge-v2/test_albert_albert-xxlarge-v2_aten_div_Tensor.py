...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/albert/albert-xxlarge-v2", "aten.div.Tensor")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 64, 9, 9]> self = ?", "Tensor other = 8.0"]])
