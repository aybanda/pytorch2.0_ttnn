...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/albert/albert-base-v2-classification", "aten.tanh.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 12, 3072]> self = ?"]])
