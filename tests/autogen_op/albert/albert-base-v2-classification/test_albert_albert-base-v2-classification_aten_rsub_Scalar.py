...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/albert/albert-base-v2-classification", "aten.rsub.Scalar")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 1, 1, 12]> self = ?", "number other = 1.0"]])
