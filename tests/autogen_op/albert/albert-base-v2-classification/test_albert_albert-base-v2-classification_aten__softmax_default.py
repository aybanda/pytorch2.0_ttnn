...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/albert/albert-base-v2-classification", "aten._softmax.default")


@pytest.mark.parametrize(
    "input_strings", [["Tensor<[1, 12, 12, 12]> self = ?", "int dim = -1", "bool half_to_float = False"]]
)
