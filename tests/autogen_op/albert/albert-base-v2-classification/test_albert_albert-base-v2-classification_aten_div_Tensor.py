...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/albert/albert-base-v2-classification", "aten.div.Tensor")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 12, 12, 12]> self = ?", "Tensor other = 8.0"]])
