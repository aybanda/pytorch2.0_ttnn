...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/albert/albert-xlarge-v2", "aten._softmax.default")


@pytest.mark.parametrize(
    "input_strings", [["Tensor<[1, 16, 9, 9]> self = ?", "int dim = -1", "bool half_to_float = False"]]
)
