...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/albert/albert-xlarge-v2", "aten.tanh.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 9, 8192]> self = ?"], ["Tensor<[1, 9, 128]> self = ?"]])
