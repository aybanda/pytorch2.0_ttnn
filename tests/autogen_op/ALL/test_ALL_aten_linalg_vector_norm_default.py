...
class AtenModule(torch.nn.Module):
    ...
    def forward(self, *args, **kwargs):
        return torch.ops.aten.linalg_vector_norm.default(*args, **kwargs)
...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/ALL", "aten.linalg_vector_norm.default")
...
@pytest.mark.parametrize(
    ...
    [
        ...
        [
            "Tensor<[64, 4, 64, 32]> self = ?",
            "number ord = 2.0",
            "Optional[List[int]] dim = [-1]",
            "bool keepdim = True",
        ],
        [
            "Tensor<[16, 8, 64, 32]> self = ?",
            "number ord = 2.0",
            "Optional[List[int]] dim = [-1]",
            "bool keepdim = True",
        ],
        [
            "Tensor<[4, 16, 64, 32]> self = ?",
            "number ord = 2.0",
            "Optional[List[int]] dim = [-1]",
            "bool keepdim = True",
        ],
        [
            "Tensor<[1, 32, 64, 32]> self = ?",
            "number ord = 2.0",
            "Optional[List[int]] dim = [-1]",
            "bool keepdim = True",
        ],
        [
            "Tensor<[64, 3, 64, 32]> self = ?",
            "number ord = 2.0",
            "Optional[List[int]] dim = [-1]",
            "bool keepdim = True",
        ],
        [
            "Tensor<[16, 6, 64, 32]> self = ?",
            "number ord = 2.0",
            "Optional[List[int]] dim = [-1]",
            "bool keepdim = True",
        ],
        [
            "Tensor<[4, 12, 64, 32]> self = ?",
            "number ord = 2.0",
            "Optional[List[int]] dim = [-1]",
            "bool keepdim = True",
        ],
        [
            "Tensor<[1, 24, 64, 32]> self = ?",
            "number ord = 2.0",
            "Optional[List[int]] dim = [-1]",
            "bool keepdim = True",
        ],
...
def test_aten(device, input_strings, input_var_only_native, input_var_check_accu, input_var_check_ttnn):
    metric = {
        "opname": "aten.linalg_vector_norm.default",
    ...
    input_args, input_kwargs, status = render_metric_string_list_to_input_args_kwargs(
        "aten.linalg_vector_norm.default", input_strings
    )
    if status == False:
