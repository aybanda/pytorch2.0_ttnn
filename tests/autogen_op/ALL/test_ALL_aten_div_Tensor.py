...
@pytest.mark.parametrize(
    ...
    [
        ...
        ["Tensor self = ?", "Tensor<[1, 1, 40]> other = ?"],
        ["Tensor self = ?", "Tensor<[1, 23, 1]> other = ?"],
        ["Tensor self = ?", "Tensor other = 128"],
        ...
        ["Tensor self = ?", "Tensor other = 20"],
        ["Tensor self = ?", "Tensor other = 10"],
        ["Tensor self = ?", "Tensor other = 5"],
        ["Tensor self = ?", "Tensor other = 3"],
        ["Tensor self = ?", "Tensor other = 2"],
        ...
        ["Tensor self = ?", "Tensor other = 37.5"],
        ["Tensor self = ?", "Tensor other = 18.75"],
        ["Tensor self = ?", "Tensor other = 9.375"],
        ["Tensor self = ?", "Tensor other = 4.6875"],
        ["Tensor self = ?", "Tensor other = 3.0"],
        ["Tensor self = ?", "Tensor other = 1.0"],
