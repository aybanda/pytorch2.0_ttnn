...
@pytest.mark.parametrize(
    ...
    [
        ...
        ["Tensor self = ?", "Tensor<[1, 1, 32]> other = ?"],
        ...
        ["Tensor<[1, 64, 30, 40]> self = ?", "Tensor other = ?"],
        ...
        ["Tensor<[1, 64, 60, 80]> self = ?", "Tensor other = ?"],
        ...
        ["Tensor<[1, 64, 120, 160]> self = ?", "Tensor other = ?"],
        ...
        ["Tensor<[1, 256, 128, 128]> self = ?", "Tensor other = ?"],
        ...
        ["Tensor<[1, 3, 800, 1066]> self = ?", "Tensor other = ?"],
        ...
        ["Tensor<[1, 3, 300, 300]> self = ?", "Tensor other = ?"],
        ...
        ["Tensor<[8732, 2]> self = ?", "Tensor other = ?"],
