...
class AtenModule(torch.nn.Module):
    ...
    def forward(self, *args, **kwargs):
        return torch.ops.aten.sigmoid.default(*args, **kwargs)
...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/ALL", "aten.sigmoid.default")
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ["Tensor<[2, 7, 2048]> self = ?"],
        ["Tensor<[6, 1, 100, 4]> self = ?"],
        ["Tensor<[1, 2, 30, 40]> self = ?"],
        ["Tensor<[1, 2, 60, 80]> self = ?"],
        ["Tensor<[1, 2, 120, 160]> self = ?"],
        ["Tensor<[1, 1, 480, 640]> self = ?"],
        ["Tensor<[1, 1, 256, 256]> self = ?"],
        ["Tensor<[1, 100, 4]> self = ?"],
        ...
        ["Tensor<[1, 528, 1, 1]> self = ?"],
        ["Tensor<[1, 1056, 1, 1]> self = ?"],
        ["Tensor<[1, 2904, 1, 1]> self = ?"],
        ["Tensor<[1, 7392, 1, 1]> self = ?"],
        ["Tensor<[1, 224, 1, 1]> self = ?"],
        ["Tensor<[1, 448, 1, 1]> self = ?"],
        ["Tensor<[1, 1232, 1, 1]> self = ?"],
        ["Tensor<[1, 3024, 1, 1]> self = ?"],
        ["Tensor<[1, 48, 1, 1]> self = ?"],
        ["Tensor<[1, 120, 1, 1]> self = ?"],
        ["Tensor<[1, 336, 1, 1]> self = ?"],
        ["Tensor<[1, 888, 1, 1]> self = ?"],
        ["Tensor<[1, 232, 1, 1]> self = ?"],
        ["Tensor<[1, 696, 1, 1]> self = ?"],
        ["Tensor<[1, 1392, 1, 1]> self = ?"],
        ["Tensor<[1, 3712, 1, 1]> self = ?"],
        ["Tensor<[1, 72, 1, 1]> self = ?"],
        ["Tensor<[1, 216, 1, 1]> self = ?"],
        ["Tensor<[1, 576, 1, 1]> self = ?"],
        ["Tensor<[1, 1512, 1, 1]> self = ?"],
        ["Tensor<[1, 104, 1, 1]> self = ?"],
        ["Tensor<[1, 208, 1, 1]> self = ?"],
        ["Tensor<[1, 440, 1, 1]> self = ?"],
        ["Tensor<[1, 64, 1, 1]> self = ?"],
        ["Tensor<[1, 144, 1, 1]> self = ?"],
        ["Tensor<[1, 320, 1, 1]> self = ?"],
        ["Tensor<[1, 784, 1, 1]> self = ?"],
        ["Tensor<[1, 896, 1, 1]> self = ?"],
        ["Tensor<[1, 2016, 1, 1]> self = ?"],
        ["Tensor<[1, 4, 64, 64]> self = ?"],
        ["Tensor<[1, 8, 64, 64]> self = ?"],
        ["Tensor<[1, 16, 64, 64]> self = ?"],
        ["Tensor<[1, 32, 64, 64]> self = ?"],
        ["Tensor<[1, 3, 64, 64]> self = ?"],
        ["Tensor<[1, 6, 64, 64]> self = ?"],
        ["Tensor<[1, 12, 64, 64]> self = ?"],
...
def test_aten(device, input_strings, input_var_only_native, input_var_check_accu, input_var_check_ttnn):
    ...
    input_args, input_kwargs, status = render_metric_string_list_to_input_args_kwargs(
        "aten.sigmoid.default", input_strings
    )
    if status == False:
