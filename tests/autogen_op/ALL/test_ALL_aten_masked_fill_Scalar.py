...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/ALL", "aten.masked_fill.Scalar")
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ["Tensor<[1, 920]> self = ?", "Tensor mask = ?", "number value = -inf"],
        [
            "Tensor<[1, 1, 45, 45]> self = ?",
            "Tensor<[1, 1, 45, 45]> mask = ?",
            "number value = -3.3895313892515355e+38",
        ],
        ["Tensor<[1, 50257]> self = ?", "Tensor<[1, 50257]> mask = ?", "number value = -inf"],
        ["Tensor<[1, 1, 1, 46]> self = ?", "Tensor<[1, 1, 1, 46]> mask = ?", "number value = -3.3895313892515355e+38"],
        [
            "Tensor<[1, 1, 1, s10 + 1]> self = ?",
            "Tensor<[1, 1, 1, s10 + 1]> mask = ?",
            "number value = -3.3895313892515355e+38",
        ],
        [
            "Tensor<[1, 1, 59, 59]> self = ?",
            "Tensor<[1, 1, 59, 59]> mask = ?",
            "number value = -3.3895313892515355e+38",
        ],
        ["Tensor<[1, 1, 1, 60]> self = ?", "Tensor<[1, 1, 1, 60]> mask = ?", "number value = -3.3895313892515355e+38"],
        [
        ...
        ["Tensor<[64, 64, 64]> self = ?", "Tensor<[64, 64, 64]> mask = ?", "number value = -100.0"],
        ["Tensor<[64, 64, 64]> self = ?", "Tensor<[64, 64, 64]> mask = ?", "number value = 0.0"],
        ["Tensor<[16, 64, 64]> self = ?", "Tensor<[16, 64, 64]> mask = ?", "number value = -100.0"],
        ["Tensor<[16, 64, 64]> self = ?", "Tensor<[16, 64, 64]> mask = ?", "number value = 0.0"],
        ["Tensor<[4, 64, 64]> self = ?", "Tensor<[4, 64, 64]> mask = ?", "number value = -100.0"],
        ["Tensor<[4, 64, 64]> self = ?", "Tensor<[4, 64, 64]> mask = ?", "number value = 0.0"],
    ],
)
