...
class AtenModule(torch.nn.Module):
    ...
    def forward(self, *args, **kwargs):
        return torch.ops.aten._unsafe_index_put.default(*args, **kwargs)
...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/ALL", "aten._unsafe_index_put.default")
...
@pytest.mark.parametrize(
    ...
    [
        ...
        [
            ...
            "List[Optional[Tensor]] indices = [None, None, <[7, 1]>, <[7]>]",
            "Tensor<[1, 960, 7, 7]> values = ?",
            "bool accumulate = True",
        ],
        [
            "Tensor<[1, 672, 7, 7]> self = ?",
            "List[Optional[Tensor]] indices = [None, None, <[14, 1]>, <[14]>]",
            "Tensor<[1, 672, 14, 14]> values = ?",
            "bool accumulate = True",
        ],
        [
            "Tensor<[1, 480, 7, 7]> self = ?",
            "List[Optional[Tensor]] indices = [None, None, <[14, 1]>, <[14]>]",
            "Tensor<[1, 480, 14, 14]> values = ?",
            "bool accumulate = True",
        ],
        [
            "Tensor<[1, 184, 7, 7]> self = ?",
            "List[Optional[Tensor]] indices = [None, None, <[14, 1]>, <[14]>]",
            "Tensor<[1, 184, 14, 14]> values = ?",
            "bool accumulate = True",
        ],
        [
            "Tensor<[1, 200, 7, 7]> self = ?",
            "List[Optional[Tensor]] indices = [None, None, <[14, 1]>, <[14]>]",
            "Tensor<[1, 200, 14, 14]> values = ?",
            "bool accumulate = True",
        ],
        [
            "Tensor<[1, 240, 14, 14]> self = ?",
            "List[Optional[Tensor]] indices = [None, None, <[28, 1]>, <[28]>]",
            "Tensor<[1, 240, 28, 28]> values = ?",
            "bool accumulate = True",
        ],
        [
            "Tensor<[1, 120, 14, 14]> self = ?",
            "List[Optional[Tensor]] indices = [None, None, <[28, 1]>, <[28]>]",
            "Tensor<[1, 120, 28, 28]> values = ?",
            "bool accumulate = True",
        ],
        [
            "Tensor<[1, 72, 28, 28]> self = ?",
            "List[Optional[Tensor]] indices = [None, None, <[56, 1]>, <[56]>]",
            "Tensor<[1, 72, 56, 56]> values = ?",
            "bool accumulate = True",
        ],
        [
            "Tensor<[1, 72, 7, 7]> self = ?",
            "List[Optional[Tensor]] indices = [None, None, <[14, 1]>, <[14]>]",
            "Tensor<[1, 72, 14, 14]> values = ?",
            "bool accumulate = True",
        ],
        [
            "Tensor<[1, 36, 7, 7]> self = ?",
            "List[Optional[Tensor]] indices = [None, None, <[28, 1]>, <[28]>]",
            "Tensor<[1, 36, 28, 28]> values = ?",
            "bool accumulate = True",
        ],
        [
...
def test_aten(device, input_strings, input_var_only_native, input_var_check_accu, input_var_check_ttnn):
    metric = {
        "opname": "aten._unsafe_index_put.default",
    ...
    input_args, input_kwargs, status = render_metric_string_list_to_input_args_kwargs(
        "aten._unsafe_index_put.default", input_strings
    )
    if status == False:
