...
class AtenModule(torch.nn.Module):
    ...
    def forward(self, *args, **kwargs):
        return torch.ops.aten.zeros.default(*args, **kwargs)
...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/ALL", "aten.zeros.default")
...
@pytest.mark.parametrize(
    ...
    [
        [
            "List[int] size = [1, 3, 720, 1280]",
            "Optional[int] dtype = torch.bfloat16",
            "Optional[Device] device = cpu",
            "Optional[bool] pin_memory = False",
        ],
        [
            "List[int] size = [1, 6, 1, 15]",
            "Optional[int] dtype = torch.bfloat16",
            "Optional[Device] device = cpu",
            "Optional[bool] pin_memory = False",
        ],
        [
            "List[int] size = [1, 6, 3, 15]",
            "Optional[int] dtype = torch.bfloat16",
            "Optional[Device] device = cpu",
            "Optional[bool] pin_memory = False",
        ],
        [
            "List[int] size = [1, 6, <s0 + 2>, 15]",
            "Optional[int] dtype = torch.bfloat16",
            "Optional[Device] device = cpu",
            "Optional[bool] pin_memory = False",
        ],
        [
            "List[int] size = [1, 6, 18, 15]",
            "Optional[int] dtype = torch.bfloat16",
            "Optional[Device] device = cpu",
            "Optional[bool] pin_memory = False",
        ],
        [
            "List[int] size = [1, 12, 1, 10]",
            "Optional[int] dtype = torch.bfloat16",
            "Optional[Device] device = cpu",
            "Optional[bool] pin_memory = False",
        ],
        [
            "List[int] size = [1, 12, 3, 10]",
            "Optional[int] dtype = torch.bfloat16",
            "Optional[Device] device = cpu",
            "Optional[bool] pin_memory = False",
        ],
        [
            "List[int] size = [1, 12, <s0 + 2>, 10]",
            "Optional[int] dtype = torch.bfloat16",
            "Optional[Device] device = cpu",
            "Optional[bool] pin_memory = False",
        ],
        [
            "List[int] size = [1, 16, 1, 10]",
            "Optional[int] dtype = torch.bfloat16",
            "Optional[Device] device = cpu",
            "Optional[bool] pin_memory = False",
        ],
        [
            "List[int] size = [1, 16, 3, 10]",
            "Optional[int] dtype = torch.bfloat16",
            "Optional[Device] device = cpu",
            "Optional[bool] pin_memory = False",
        ],
        [
            "List[int] size = [1, 16, <s0 + 2>, 10]",
            "Optional[int] dtype = torch.bfloat16",
            "Optional[Device] device = cpu",
            "Optional[bool] pin_memory = False",
        ],
        [
            "List[int] size = [1, 8, 1, 10]",
            "Optional[int] dtype = torch.bfloat16",
            "Optional[Device] device = cpu",
            "Optional[bool] pin_memory = False",
        ],
        [
            "List[int] size = [1, 8, 3, 10]",
            "Optional[int] dtype = torch.bfloat16",
            "Optional[Device] device = cpu",
            "Optional[bool] pin_memory = False",
        ],
        [
            "List[int] size = [1, 8, <s0 + 2>, 10]",
            "Optional[int] dtype = torch.bfloat16",
            "Optional[Device] device = cpu",
            "Optional[bool] pin_memory = False",
        ],
...
def test_aten(device, input_strings, input_var_only_native, input_var_check_accu, input_var_check_ttnn):
    ...
    input_args, input_kwargs, status = render_metric_string_list_to_input_args_kwargs(
        "aten.zeros.default", input_strings
    )
    if status == False:
