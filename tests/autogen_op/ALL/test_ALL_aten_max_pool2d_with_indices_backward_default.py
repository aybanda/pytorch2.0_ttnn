...
class AtenModule(torch.nn.Module):
    ...
    def forward(self, *args, **kwargs):
        return torch.ops.aten.max_pool2d_with_indices_backward.default(*args, **kwargs)
...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/ALL", "aten.max_pool2d_with_indices_backward.default")
...
@pytest.mark.parametrize(
    ...
    [
        ...
        [
            "Tensor<[1, 320, 14, 14]> grad_output = ?",
        ...
        [
            ...
            "List[int] dilation = [1, 1]",
            "bool ceil_mode = False",
            "Tensor<[1, 256, 16, 16]> indices = ?",
        ],
        [
            "Tensor<[1, 128, 32, 32]> grad_output = ?",
        ...
        [
            ...
            "List[int] dilation = [1, 1]",
            "bool ceil_mode = False",
            "Tensor<[1, 384, 17, 17]> indices = ?",
        ],
        [
            "Tensor<[1, 192, 35, 35]> grad_output = ?",
            "Tensor<[1, 192, 71, 71]> self = ?",
            "List[int] kernel_size = [3, 3]",
            "List[int] stride = [2, 2]",
            "List[int] padding = [0, 0]",
            "List[int] dilation = [1, 1]",
            "bool ceil_mode = False",
            "Tensor<[1, 192, 35, 35]> indices = ?",
        ],
        [
            ...
            "List[int] dilation = [1, 1]",
            "bool ceil_mode = False",
            "Tensor<[1, 64, 73, 73]> indices = ?",
        ],
    ],
)
def test_aten(device, input_strings, input_var_only_native, input_var_check_accu, input_var_check_ttnn):
    metric = {
        "opname": "aten.max_pool2d_with_indices_backward.default",
    ...
    input_args, input_kwargs, status = render_metric_string_list_to_input_args_kwargs(
        "aten.max_pool2d_with_indices_backward.default", input_strings
    )
    if status == False:
