...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/regnet_x_3_2gf", "aten.view.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 1008, 1, 1]> self = ?", "List[int] size = [1, 1008]"]])
