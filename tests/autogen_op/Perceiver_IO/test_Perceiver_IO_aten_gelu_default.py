...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/Perceiver IO", "aten.gelu.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 256, 1280]> self = ?"], ["Tensor<[1, 2048, 768]> self = ?"]])
