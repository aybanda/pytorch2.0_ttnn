...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/CLIP-train", "aten.sigmoid.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 50, 3072]> self = ?"], ["Tensor<[2, 7, 2048]> self = ?"]])
