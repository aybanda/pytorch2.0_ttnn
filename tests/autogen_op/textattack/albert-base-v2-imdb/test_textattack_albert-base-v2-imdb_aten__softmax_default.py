...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/textattack/albert-base-v2-imdb", "aten._softmax.default")


@pytest.mark.parametrize(
    "input_strings", [["Tensor<[1, 12, 9, 9]> self = ?", "int dim = -1", "bool half_to_float = False"]]
)
