...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/textattack/albert-base-v2-imdb", "aten._unsafe_view.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 9, 12, 64]> self = ?", "List[int] size = [1, 9, 768]"]])
