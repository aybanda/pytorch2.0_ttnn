...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/textattack/albert-base-v2-imdb", "aten.pow.Tensor_Scalar")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 9, 3072]> self = ?", "number exponent = 3.0"]])
