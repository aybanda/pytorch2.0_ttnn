...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/textattack/albert-base-v2-imdb", "aten.permute.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 9, 12, 64]> self = ?", "List[int] dims = [0, 2, 1, 3]"]])
