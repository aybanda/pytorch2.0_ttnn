...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/textattack/albert-base-v2-imdb", "aten.rsub.Scalar")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 1, 1, 9]> self = ?", "number other = 1.0"]])
