...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/textattack/albert-base-v2-imdb", "aten.unsqueeze.default")


@pytest.mark.parametrize(
    "input_strings", [["Tensor<[1, 9]> self = ?", "int dim = 1"], ["Tensor<[1, 1, 9]> self = ?", "int dim = 2"]]
)
