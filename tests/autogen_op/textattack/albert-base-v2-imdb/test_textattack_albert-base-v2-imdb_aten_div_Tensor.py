...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/textattack/albert-base-v2-imdb", "aten.div.Tensor")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 12, 9, 9]> self = ?", "Tensor other = 8.0"]])
