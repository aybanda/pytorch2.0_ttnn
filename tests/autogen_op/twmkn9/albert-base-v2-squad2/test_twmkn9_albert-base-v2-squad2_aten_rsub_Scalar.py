...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/twmkn9/albert-base-v2-squad2", "aten.rsub.Scalar")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 1, 1, 14]> self = ?", "number other = 1.0"]])
