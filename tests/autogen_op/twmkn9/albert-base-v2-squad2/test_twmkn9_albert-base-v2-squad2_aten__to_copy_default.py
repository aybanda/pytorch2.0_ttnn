...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/twmkn9/albert-base-v2-squad2", "aten._to_copy.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 1, 1, 14]> self = ?", "Optional[int] dtype = torch.bfloat16"]])
