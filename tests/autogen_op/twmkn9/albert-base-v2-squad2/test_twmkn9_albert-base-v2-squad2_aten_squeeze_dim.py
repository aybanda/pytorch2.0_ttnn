...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/twmkn9/albert-base-v2-squad2", "aten.squeeze.dim")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 14, 1]> self = ?", "int dim = -1"]])
