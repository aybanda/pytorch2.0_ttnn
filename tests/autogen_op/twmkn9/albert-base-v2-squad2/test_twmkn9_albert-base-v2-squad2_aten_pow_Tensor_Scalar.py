...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/twmkn9/albert-base-v2-squad2", "aten.pow.Tensor_Scalar")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 14, 3072]> self = ?", "number exponent = 3.0"]])
