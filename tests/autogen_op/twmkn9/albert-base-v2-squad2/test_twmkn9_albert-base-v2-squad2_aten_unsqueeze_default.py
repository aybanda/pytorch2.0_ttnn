...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/twmkn9/albert-base-v2-squad2", "aten.unsqueeze.default")


@pytest.mark.parametrize(
    "input_strings", [["Tensor<[1, 14]> self = ?", "int dim = 1"], ["Tensor<[1, 1, 14]> self = ?", "int dim = 2"]]
)
