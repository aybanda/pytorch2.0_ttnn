...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/twmkn9/albert-base-v2-squad2", "aten.permute.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 14, 12, 64]> self = ?", "List[int] dims = [0, 2, 1, 3]"]])
