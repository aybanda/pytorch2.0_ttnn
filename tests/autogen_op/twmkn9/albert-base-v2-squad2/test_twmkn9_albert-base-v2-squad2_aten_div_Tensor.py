...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/twmkn9/albert-base-v2-squad2", "aten.div.Tensor")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 12, 14, 14]> self = ?", "Tensor other = 8.0"]])
