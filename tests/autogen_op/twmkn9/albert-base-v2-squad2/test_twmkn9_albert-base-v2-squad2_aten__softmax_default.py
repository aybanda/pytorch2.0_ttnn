...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/twmkn9/albert-base-v2-squad2", "aten._softmax.default")


@pytest.mark.parametrize(
    "input_strings", [["Tensor<[1, 12, 14, 14]> self = ?", "int dim = -1", "bool half_to_float = False"]]
)
