...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/Mnist-train", "aten.max_pool2d_with_indices.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 64, 24, 24]> self = ?", "List[int] kernel_size = [2, 2]"]])
