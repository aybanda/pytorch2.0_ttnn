...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/Bloom", "aten.embedding.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[250880, 1536]> weight = ?", "Tensor<[1, 32]> indices = ?"]])
