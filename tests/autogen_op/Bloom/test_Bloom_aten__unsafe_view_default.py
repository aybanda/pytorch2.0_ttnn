...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/Bloom", "aten._unsafe_view.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 32, 16, 96]> self = ?", "List[int] size = [1, 32, 1536]"]])
