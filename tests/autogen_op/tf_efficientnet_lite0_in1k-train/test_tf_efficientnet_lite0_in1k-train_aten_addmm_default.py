...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/tf_efficientnet_lite0.in1k-train", "aten.addmm.default")


@pytest.mark.parametrize(
    "input_strings", [["Tensor<[1000]> self = ?", "Tensor<[1, 1280]> mat1 = ?", "Tensor<[1280, 1000]> mat2 = ?"]]
)
