...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/SqueezeBERT", "aten.mul.Tensor")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 1, 1, 8]> self = ?", "Tensor other = -3.3895313892515355e+38"]])
