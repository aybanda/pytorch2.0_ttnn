...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/OpenPose V2", "aten.add.Tensor")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 128, 28, 28]> self = ?", "Tensor<[1, 128, 28, 28]> other = ?"]])
