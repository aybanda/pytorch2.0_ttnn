...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/tf_efficientnet_lite2.in1k-train", "aten.mean.dim")


@pytest.mark.parametrize(
    "input_strings", [["Tensor<[1, 1280, 9, 9]> self = ?", "Optional[List[int]] dim = [-1, -2]", "bool keepdim = True"]]
)
