...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/regnet_y_800mf", "aten.view.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 784, 1, 1]> self = ?", "List[int] size = [1, 784]"]])
