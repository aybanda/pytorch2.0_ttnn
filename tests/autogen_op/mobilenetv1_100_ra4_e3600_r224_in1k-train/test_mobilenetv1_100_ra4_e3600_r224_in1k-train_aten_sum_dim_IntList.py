...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/mobilenetv1_100.ra4_e3600_r224_in1k-train", "aten.sum.dim_IntList")


@pytest.mark.parametrize(
    "input_strings", [["Tensor<[1, 1000]> self = ?", "Optional[List[int]] dim = [0]", "bool keepdim = True"]]
)
