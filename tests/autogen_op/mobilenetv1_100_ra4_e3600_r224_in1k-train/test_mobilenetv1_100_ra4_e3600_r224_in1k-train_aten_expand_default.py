...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/mobilenetv1_100.ra4_e3600_r224_in1k-train", "aten.expand.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 1024, 1, 1]> self = ?", "List[int] size = [1, 1024, 7, 7]"]])
