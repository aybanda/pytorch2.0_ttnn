...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/mobilenetv1_100.ra4_e3600_r224_in1k-train", "aten.addmm.default")


@pytest.mark.parametrize(
    "input_strings", [["Tensor<[1000]> self = ?", "Tensor<[1, 1024]> mat1 = ?", "Tensor<[1024, 1000]> mat2 = ?"]]
)
