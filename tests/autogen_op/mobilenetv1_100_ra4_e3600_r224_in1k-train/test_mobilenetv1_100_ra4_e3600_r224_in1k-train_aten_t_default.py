...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/mobilenetv1_100.ra4_e3600_r224_in1k-train", "aten.t.default")


@pytest.mark.parametrize(
    "input_strings",
    [["Tensor<[1000, 1024]> self = ?"], ["Tensor<[1024, 1000]> self = ?"], ["Tensor<[1, 1000]> self = ?"]],
)
