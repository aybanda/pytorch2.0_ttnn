...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/inception_v4.tf_in1k-train", "aten.expand.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 1536, 1, 1]> self = ?", "List[int] size = [1, 1536, 8, 8]"]])
