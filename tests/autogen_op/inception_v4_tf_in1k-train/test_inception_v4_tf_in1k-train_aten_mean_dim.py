...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/inception_v4.tf_in1k-train", "aten.mean.dim")


@pytest.mark.parametrize(
    "input_strings", [["Tensor<[1, 1536, 8, 8]> self = ?", "Optional[List[int]] dim = [-1, -2]", "bool keepdim = True"]]
)
