...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/inception_v4.tf_in1k-train", "aten.addmm.default")


@pytest.mark.parametrize(
    "input_strings", [["Tensor<[1000]> self = ?", "Tensor<[1, 1536]> mat1 = ?", "Tensor<[1536, 1000]> mat2 = ?"]]
)
