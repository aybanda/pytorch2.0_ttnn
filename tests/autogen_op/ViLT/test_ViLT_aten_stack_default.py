...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/ViLT", "aten.stack.default")


@pytest.mark.parametrize("input_strings", [["List[Tensor] tensors = [<[12, 16]>, _folded_expand_1]", "int dim = -1"]])
