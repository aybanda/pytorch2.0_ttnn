...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/MLPMixer-train", "aten.add.Tensor")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 256, 512]> self = ?", "Tensor<[1, 256, 512]> other = ?"]])
