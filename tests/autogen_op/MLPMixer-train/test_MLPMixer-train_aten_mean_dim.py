...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/MLPMixer-train", "aten.mean.dim")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 512, 256]> self = ?", "Optional[List[int]] dim = [2]"]])
