...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/MLPMixer-train", "aten.gelu.default")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 1024, 512]> self = ?"], ["Tensor<[1, 256, 256]> self = ?"]])
