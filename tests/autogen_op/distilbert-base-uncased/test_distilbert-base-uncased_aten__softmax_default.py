...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/distilbert-base-uncased", "aten._softmax.default")


@pytest.mark.parametrize(
    "input_strings", [["Tensor<[1, 12, 16, 16]> self = ?", "int dim = -1", "bool half_to_float = False"]]
)
