...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/distilbert-base-uncased", "aten.div.Tensor")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 12, 16, 64]> self = ?", "Tensor other = 8.0"]])
