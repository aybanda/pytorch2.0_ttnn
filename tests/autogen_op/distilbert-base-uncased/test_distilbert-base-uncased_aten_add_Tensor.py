...
def teardown_module(module):
    print(metrics)
    save_pickle(metrics, "metrics-autogen-op/distilbert-base-uncased", "aten.add.Tensor")


@pytest.mark.parametrize("input_strings", [["Tensor<[1, 16, 768]> self = ?", "Tensor<[1, 16, 768]> other = ?"]])
